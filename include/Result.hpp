...
inline std::string toString(IndexError err)
{
    ...
    case IndexError::TransactionAlreadyFinished:
        return "Transaction already finished";
    case IndexError::TransactionCopyFailed:
        return "Failed to copy index for transaction";
    case IndexError::TransactionCommitFailed:
        return "Failed to apply transaction changes";
    case IndexError::ActiveTransactionExists:
        return "Another transaction is already active";
    }
